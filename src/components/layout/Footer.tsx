        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl">Jay's</span>
            </div>
            <p className="text-gray-300 text-sm mb-4">
              Serving delicious ice cream treats in Connecticut since 2022.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">1-203-514-4610</p>
            <p className="text-gray-300 mb-2">jaysicecreamshopct@outlook.com</p>
            <p className="text-gray-300">Connecticut, USA</p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2">
              ...
              <span className="text-gray-300">12PM - 10PM</span>
